...
public class Kraken extends Criaturas{


    public Kraken(String nome, int ataque, int defesa, int vida) {
        super(nome, ataque, defesa, vida, Habilidades.AGUA);
    }
    ...
    public int defender(Criaturas atacante) {
        ...
        if (atacante.getHabilidad() == Habilidades.HIELO) {
            this.setVida(0);
            return 10;
        } else {
